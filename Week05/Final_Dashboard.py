...
Function that takes airline data as input and create 5 dataframes based on the grouping condition to be used 
for plottling charts and grphs.
...
This function takes in airline data and selected year as an input and performs computation for creating charts
and plots.
...
app.layout = html.Div(children=[ 
                                ...
                                html.Div([
                                    ...
                                    ], style={'display':'flex'}), # Setting display to flex to make it 
                                    # responsive
                                ...
                                # Add Computed graphs
                                # Observe how we add an empty division and providing an id that will be updated 
                                # during callback
                                html.Div([ ], id='plot1'),
...
@app.callback( [Output(component_id='plot1', component_property='children'),
               ...
               # Holding output state till user enters all the form information. In this case, it will
               # be chart type and year
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
        ...
        if chart == 'OPT1':
            ...
            # This covers chart type 2 and we have completed this exercise under Flight Delay Time Statistics
            # Dashboard section
            # Compute required information for creating graph from the data
